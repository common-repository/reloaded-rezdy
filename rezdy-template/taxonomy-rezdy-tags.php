<?php
    ...
    $rzd_tag_slug = get_queried_object()->slug;
    $rzd_tag_name = get_queried_object()->name;
?>
    <div class="rzd_main">
    	<h1><?php echo 'Tag: '.$rzd_tag_name; ?></h1>
        ...
        <?php	
            ...
            $rzd_tags_args = array(
                ...
                $rzd_tags_qry = new WP_Query($rzd_tags_args);

                while($rzd_tags_qry->have_posts()) :
                    $rzd_tags_qry->the_post();
        ?>            
